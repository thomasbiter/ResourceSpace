...
<script type="text/javascript">
    ...
    function UserRatingSet(userref,ref,rating)
    {
        ...
        if (UserRatingDone) {return false;}
        new Ajax.Request("<?php echo $baseurl ?>/pages/m/ajax/user_rating_save.php?user="+userref+"&ref="+ref+"&rating=" + rating,{method: 'post'});
        UserRatingDone=true;
...
<table>
    <tr class="DownloadDBlend">
        <td align="center" id="UserRatingMessage"><?php if($access==0){ echo $lang["ratethisresource"]; }  ?></td>
        <td width="33%" align="center" class="RatingStars" onMouseOut="UserRatingDisplay(<?php echo $rating ?>,'StarWhite');">
            ...
            <?php if($access==0){ ?>
            <a href="#" onMouseOver="UserRatingDisplay(<?php echo $n ?>,'StarSelect');" onClick="UserRatingSet(<?php echo $userref ?>,<?php echo $ref ?>,<?php echo $n ?>);return false;" id="RatingStarLink<?php echo $n ?>"><span data-theme="a" id="RatingStar<?php echo $n ?>" class="Star<?php echo ($n <= $rating ? "White" : "Grey") ?>"><img src="../../gfx/interface/sp.gif" width="15" height="15"></span></a><?php
                #&#9733;
            }
            else{ ?>
                <span data-theme="a" id="RatingStar<?php echo $n ?>" class="Star<?php echo ($n <= $rating ? "White" : "Grey") ?>"><img src="../../gfx/interface/sp.gif" width="15" height="15"></span><?php
                #&#9733;
            }
            }
            ?>
